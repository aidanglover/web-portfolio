...
// container.appendChild(createImageContainer('images/eye.png', 'Image 3', 'Eye', 'Check out this orange image. Pretty neat right? I thought so too.'));
...
secondImageContainer.style.top = '400px'; // Adjust the value as needed

// Adjust the left position of the second image container
secondImageContainer.style.left = '600px'; // Adjust the value as needed
